...
define('js/app/controller/order/OrderDetail', ['js/app/controller/base', 'js/app/module/validate/validate', 'js/app/interface/GeneralCtr', 'js/app/interface/UserCtr', 'js/app/interface/TradeCtr', 'js/app/controller/Top', 'js/app/controller/foo'], function (base, Validate, GeneralCtr, UserCtr, TradeCtr, Top, Foo) {
    ...
    function init() {
        ...
        $.when(GeneralCtr.getDictList({ "parentKey": "pay_type" }), GeneralCtr.getDictList({ "parentKey": "trade_order_status" }), GeneralCtr.getSysConfig('tips')).then(function (payTypeData, tradeOderStatusData, tipsData) {
    ...
    function getOrderDetail() {
        return TradeCtr.getOrderDetail(code).then(function (data) {
    ...
    function getAdvertiseDetail() {
        return TradeCtr.getAdvertiseDetail(adsCode).then(function (data) {
    ...
    function addListener() {
        ...
        $(".orderDetail-middle .title .item").click(function () {
            ...
            if (!_this.hasClass("on")) {
                ...
                $(".orderDetail-middle .content-wrap .wrap").eq(_this.index()).removeClass("hidden").siblings(".wrap").addClass("hidden");
            }
        });
        //--聊天 star--
        ...
        $(".cancelBtn").on("click", function () {
            base.confirm(base.getText('确认取消交易？'), base.getText('取消'), base.getText('确定')).then(function () {
                base.showLoadingSpin();
                TradeCtr.cancelOrder(code).then(function () {
                    base.hideLoadingSpin();
        ...
        $(".releaseBtn").on("click", function () {
            base.confirm(base.getText('确认解冻货币？'), base.getText('取消'), base.getText('确定')).then(function () {
                base.showLoadingSpin();
                TradeCtr.releaseOrder(code).then(function () {
                    base.hideLoadingSpin();
        ...
        $("#commentDialog .subBtn").click(function () {
            ...
            base.showLoadingSpin();
            TradeCtr.commentOrder(code, comment, content).then(function (data) {
                base.hideLoadingSpin();
