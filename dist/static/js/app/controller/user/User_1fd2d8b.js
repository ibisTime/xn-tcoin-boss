...
define('js/app/controller/user/User', ['js/app/controller/base', 'js/app/interface/UserCtr', 'js/app/interface/GeneralCtr', 'js/app/module/qiniu/index', 'js/app/controller/Top', 'js/app/controller/foo'], function (base, UserCtr, GeneralCtr, QiniuUpdata, Top, Foo) {
    ...
    function changePhoto() {
        return UserCtr.changePhoto($("#editPhotoDialog .img-wrap .photoWrapSquare .photo").attr("data-src")).then(function (data) {
            base.hideLoadingSpin();
