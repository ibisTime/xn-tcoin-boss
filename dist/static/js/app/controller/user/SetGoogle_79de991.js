...
define('js/app/controller/user/SetGoogle', ['js/app/controller/base', 'js/app/module/validate/validate', 'js/app/module/smsCaptcha/smsCaptcha', 'js/app/interface/UserCtr', 'js/app/controller/Top', 'js/app/controller/foo'], function (base, Validate, smsCaptcha, UserCtr, Top, Foo) {
    ...
    function openGoogle(params) {
        return UserCtr.openGoogle(params).then(function () {
    ...
    function closeGoogle(googleCaptcha, smsCaptcha) {
        return UserCtr.closeGoogle(googleCaptcha, smsCaptcha).then(function () {
            base.hideLoadingSpin();
    ...
    function getGooglePwd() {
        return UserCtr.getGooglePwd().then(function (data) {
