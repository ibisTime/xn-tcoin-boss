...
define('js/app/controller/user/SetTradePwd', ['js/app/controller/base', 'js/app/module/validate/validate', 'js/app/module/smsCaptcha/smsCaptcha', 'js/app/interface/UserCtr', 'js/app/controller/Top', 'js/app/controller/foo'], function (base, Validate, smsCaptcha, UserCtr, Top, Foo) {
	...
	function setTradePwd(tradePwd, smsCaptcha) {
		return UserCtr.setTradePwd(tradePwd, smsCaptcha).then(function () {
	...
	function changeTradePwd(tradePwd, smsCaptcha) {
		return UserCtr.changeTradePwd(tradePwd, smsCaptcha).then(function () {
			base.hideLoadingSpin();
