...
define('js/app/controller/user/SetPhone', ['js/app/controller/base', 'js/app/module/validate/validate', 'js/app/module/smsCaptcha/smsCaptcha', 'js/app/interface/UserCtr', 'js/app/controller/Top', 'js/app/controller/foo'], function (base, Validate, smsCaptcha, UserCtr, Top, Foo) {
    ...
    function setPhone(mobile, smsCaptcha) {
        return UserCtr.setPhone(mobile, smsCaptcha).then(function () {
            base.hideLoadingSpin();
    ...
    function detPhone(mobile, smsCaptcha) {
        return UserCtr.detPhone(mobile, smsCaptcha).then(function () {
            base.hideLoadingSpin();
            base.showMsg(base.getText('设置成功', langType));
            sessionStorage.setItem("mobile", mobile);
            setTimeout(function () {
