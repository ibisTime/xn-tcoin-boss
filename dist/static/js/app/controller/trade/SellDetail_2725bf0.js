...
define('js/app/controller/trade/SellDetail', ['js/app/controller/base', 'js/app/module/validate/validate', 'js/app/interface/GeneralCtr', 'js/app/interface/UserCtr', 'js/app/interface/TradeCtr', 'js/app/interface/AccountCtr', 'js/app/module/tencentChat/index', 'js/app/controller/Top', 'js/app/controller/foo'], function (base, Validate, GeneralCtr, UserCtr, TradeCtr, AccountCtr, TencentChat, Top, Foo) {
    ...
    function init() {
        ...
        $.when(GeneralCtr.getSysConfig("trade_remind") // 测试
        ).then(function (data) {
    ...
    function sellETH() {
        ...
        return TradeCtr.sellETH(config).then(function (data) {
            console.log(data);
    ...
    function addListener() {
        ...
        $(".det-lx").click(function () {
            base.showLoadingSpin();
            // 购买开始聊天，提交交易订单
            TradeCtr.chatOrderSell(code).then(function (data) {
