...
define('js/app/controller/trade/BuyDetail', ['js/app/controller/base', 'js/app/module/validate/validate', 'js/app/interface/GeneralCtr', 'js/app/interface/UserCtr', 'js/app/interface/TradeCtr', 'js/app/interface/AccountCtr', 'js/app/module/tencentChat/index', 'js/app/controller/Top', 'js/app/controller/foo'], function (base, Validate, GeneralCtr, UserCtr, TradeCtr, AccountCtr, TencentChat, Top, Foo) {
    ...
    function init() {
        ...
        $.when(GeneralCtr.getSysConfig("trade_remind")).then(function (data) {
    ...
    function getAdvertiseDetail() {
        return TradeCtr.getAdvertiseDetail(code).then(function (data) {
            ...
            var totalCountString = base.formatMoney(data.totalCountString, '', tradeCoin);
            ...
            $.when(getAccount(data.tradeCoin), getUser());
    ...
    function buyETH() {
        ...
        return TradeCtr.buyETH(config).then(function (data) {
    ...
    function addListener() {
        ...
        $("#buyEth").keyup(function () {
            var truePrice = $("#buyEth").val() * config.tradePrice;
        ...
        $(".det-lx").click(function () {
            base.showLoadingSpin();
            // 购买开始聊天，提交交易订单
            TradeCtr.chatOrderBuy(code).then(function (data) {
