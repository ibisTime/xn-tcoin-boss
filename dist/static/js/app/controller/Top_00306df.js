...
define('js/app/controller/Top', ['js/app/controller/base', 'js/app/interface/GeneralCtr', 'js/app/interface/AccountCtr', 'js/app/interface/UserCtr', 'js/app/module/tencentCloudLogin/index'], function (base, GeneralCtr, AccountCtr, UserCtr, TencentCloudLogin) {
     ...
     */
    function initSocket() {
        var ws = new WebSocket('ws://192.168.0.162:8080');
        ...
        ws.onmessage = function (event) {
            ...
            var audio_type = void 0;
            var audio_message = $('.audio-message');
            if (audio_type == 1) {
                audio_message.attr('src', '/static/images/type1.mp4').play();
            } else {
                audio_message.attr('src', '/static/images/type2.mp4').play();
            }
            var taget = $('#head-user-wrap .head-user .msg_num');
            var msg_num = +taget.text();
            taget.text(msg_num + 1);
            // let adverHtml = '';
            // adverHtml =`<li class="goHref" data-href="../user/user.html">
            //                 <img src="/static/images/system-msg.png">
            //                 <div class="message-text">
            //                     <p class="message-title">系统消息</p>
            //                     <span class="message-content">系统将于明日9时更新</span>
            //                 </div>
            //             </li>
            //             <li>
            //                 <img src="/static/images/order-msg.png">
            //                 <div class="message-text">
            //                     <p class="message-title">订单消息</p>
            //                     <span class="message-content">有人购买了您的订单，快…</span>
            //                 </div>
            //             </li>`
            // $('.down-wrap-message ul').html(adverHtml);
        };
