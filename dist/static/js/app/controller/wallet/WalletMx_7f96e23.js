...
define('js/app/controller/wallet/WalletMx', ['js/app/controller/base', 'js/lib/pagination/jquery.pagination', 'js/app/interface/AccountCtr', 'js/app/interface/GeneralCtr', 'js/app/interface/UserCtr', 'js/app/controller/Top', 'js/app/controller/foo'], function (base, pagination, AccountCtr, GeneralCtr, UserCtr, Top, Foo) {
    ...
    var bizTypeList = {
        ...
        '6': ['game_in'],
        '7': ['game_out'],
        '8': ['ccorder_frozen', 'ccorder_unfrozen_revoke', 'ccorder_unfrozen_trade', 'bborder_frozen', 'bborder_unfrozen_revoke', 'bborder_unfrozen_trade', 'withdraw_frozen', 'withdraw_unfrozen', 'accept_frozen', 'accept_unfrozen']
    },
        bizTypeValueList = {};
    ...
    function getPageFlow(params) {
        return AccountCtr.getPageFlow(params, true).then(function (data) {
            var lists = data.list;
            if (data.list.length) {
                var html = "";
