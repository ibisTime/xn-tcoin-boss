...
define('js/app/controller/Top', ['js/app/controller/base', 'js/app/interface/GeneralCtr', 'js/app/interface/AccountCtr', 'js/app/interface/UserCtr', 'js/app/module/tencentCloudLogin/index', 'js/app/interface/TradeCtr'], function (base, GeneralCtr, AccountCtr, UserCtr, TencentCloudLogin, TradeCtr) {
    ...
    function initSocket() {
        ...
        ws.onmessage = function (event) {
            ...
            if (audio_type == 1) {
                console.log('-------2');
                var audio_message2 = document.getElementById('audio-message2').play();
                var playPromise2 = audio_message2.play();
                ...
                console.log('---------1');
                var audio_message1 = document.getElementById('audio-message1').play();
                var playPromise1 = audio_message1.play();
                if (playPromise1 !== null) {
                    playPromise1.catch(function () {
                        audio_message1.play();
                    });
                }
            }
    ...
    $(".down-wrap-message").click(function () {});
