...
define('js/app/controller/public/Article', ['js/app/controller/base', 'js/app/util/ajax', 'js/app/interface/GeneralCtr', 'js/app/controller/Top', 'js/app/controller/foo'], function (base, Ajax, GeneralCtr, Top, Foo) {
    ...
    function init() {
        ...
        var wLi = $('.article-left li').eq(key);
        wLi.addClass('sel-li');
    ...
    function getSysConfig(ckey) {
        return GeneralCtr.getSysConfig(ckey).then(function (data) {
