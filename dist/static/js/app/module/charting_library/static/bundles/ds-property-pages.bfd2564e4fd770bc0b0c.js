...
webpackJsonp([3], { 1076: function _(e, t, o) {
    "use strict";
    function i(e, t, o) {
      a.call(this, e, t), this._linetool = o, this.prepareLayout();
        ...
        s = n.SimpleStringBinder;o(241), inherit(i, a), i.BarIndexPastLimit = -5e4, i.BarIndexFutureLimit = 15e3, i.prototype.bindBarIndex = function (e, t, o, n) {
      var a = [p(e.value()), r(i.BarIndexPastLimit), l(i.BarIndexFutureLimit)];this.bindControl(this.createStringBinder(t, e, a, !0, o, n));
      ...
      var t,
        ...
        return a.format(e);
          ...
          l = function l(e) {
        var t = a.parse(e);if (t.res) return t.price ? t.price : t.value;
      },
          p = $("<input type='text'>");return p.TVTicker({ step: a._minMove / a._priceScale || 1, formatter: r, parser: l }), e && (t = [function (t) {
        var o = l(t);return void 0 === o ? e.value() : o;
      }], o = "Change " + n.title() + " point price", i = this.createStringBinder(p, e, t, !1, this.model(), o), i.addFormatter(function (e) {
        return a.format(e);
      }), this.bindControl(i)), p;
      ...
      var i,
          ...
          l,
          p = $("<tr>"),
          s = $("<td>");return s.html($.t("Price") + o), s.appendTo(p), i = $("<td>"), i.appendTo(p), n = this.createPriceEditor(t.price), n.appendTo(i), a = $("<td>"), a.html($.t("Bar #")), a.appendTo(p), r = $("<td>"), r.appendTo(p), l = $("<input type='text'>"), l.appendTo(r), l.addClass("ticker"), this.bindBarIndex(t.bar, l, this.model(), "Change " + this._linetool.title() + " point bar index"), p;
      ...
      var t,
          ...
          l = r.length;for (t = 0; t < r.length; t++) {
        o = r[t], (i = this._linetool.properties().points[t]) && (n = t || l > 1 ? " " + (t + 1) : "", a = this._createPointRow(o, i, n), a.appendTo(e));
      }
    ...
    function i(e, t, o) {
      n.call(this, e, t, o), this.prepareLayout();
        ...
        u = o(1198).createTransparencyEditor;inherit(i, n), i.prototype.addLevelEditor = function (e, t) {
      var o,
          i,
          n,
          a,
  ...
  }, 1083: function _(e, t, o) {
    "use strict";
    (function (t) {
      function i(e, t, o) {
        var i,
            n,
            a = t.m_model.properties();l.call(this, a, t), i = this._series = t.mainSeries(), this._chart = t.m_model, this._model = t, this._source = o, this._property = a, this._seriesProperty = i.properties(), this._scaleProperty = i.priceScale().properties(), this._mainSeriesScaleRatioProperty = t.mainSeriesScaleRatioProperty(), n = null, t.m_model.panes().forEach(function (e) {
      ...
      var n = o(1234),
          ...
          P = o(248),
          x = (o(112).createConfirmDialog, o(40).trackEvent);inherit(i, l), inherit(i, n), i.prototype.setScalesOpenTab = function () {
      ...
      }, i.prototype.loadTheme = function (e, t, o) {}, i.prototype.applyTheme = function (e, t) {
        ...
        if (this._hasSeriesStyleLayout) switch ($(this._barsTbody).add(this._barsColorerTbody).add(this._renkoTbody).add(this._pbTbody).add(this._kagiTbody).add(this._pnfTbody).add(this._candlesTbody).add(this._candlesColorerTbody).add(this._hollowCandlesTbody).add(this._lineTbody).add(this._areaTbody).add(this._haTbody).add(this._haColorerTbody).add(this._baselineTbody).css("display", "none"), this._seriesProperty.style.value()) {case _.STYLE_BARS:
            this._barsTbody.css("display", "table-row-group"), this._barsColorerTbody.css("display", "table-row-group");break;case _.STYLE_CANDLES:
            this._candlesTbody.css("display", "table-row-group"), this._candlesColorerTbody.css("display", "table-row-group");break;case _.STYLE_HOLLOW_CANDLES:
            this._hollowCandlesTbody.css("display", "table-row-group");break;case _.STYLE_LINE:
            this._lineTbody.css("display", "table-row-group");break;case _.STYLE_AREA:
            this._areaTbody.css("display", "table-row-group");break;case _.STYLE_RENKO:
            this._renkoTbody.css("display", "table-row-group");break;case _.STYLE_PB:
            this._pbTbody.css("display", "table-row-group");break;case _.STYLE_KAGI:
            this._kagiTbody.css("display", "table-row-group");break;case _.STYLE_PNF:
            this._pnfTbody.css("display", "table-row-group");break;case _.STYLE_HEIKEN_ASHI:
            this._haTbody.css("display", "table-row-group"), this._haColorerTbody.css("display", "table-row-group");break;case _.STYLE_BASELINE:
        ...
        var e,
            ...
            i = this._model.model().properties().paneProperties.bottomMargin;o.listeners().fire(o), i.listeners().fire(i), e = this._chart.timeScale(), e.restoreRightOffsetPropertyToDefault(), t = this._model.model().properties().timezone, t.listeners().fire(t);
      }, i.prototype.defaultProperties = function () {
        var e = this,
            t = [e._seriesProperty.extendedHours, e._property.scalesProperties.showLeftScale, e._property.scalesProperties.showRightScale].map(function (e) {
          return { property: e, previousValue: e.value() };
        });return setTimeout(function () {
          t.forEach(function (e) {
            e.property.value() !== e.previousValue && e.property.listeners().fire(e.property);
          });var o = new k("chartproperties.paneProperties.rightAxisProperties");["autoScale", "percentage", "log"].forEach(function (t) {
            var i = e._scaleProperty[t],
                n = o[t].value();n !== i.value() && i.setValue(n);
          });
    ...
    function i(e, t, o) {
      n.call(this, e, t, o), this.prepareLayout();
        ...
        l = a.ColorBinding,
        p = a.SimpleComboBinder;inherit(i, n), i.prototype.prepareLayout = function () {
      var e, t, o, i, n;this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">').css({ width: "100%" }), e = $("<input type='text'>").css({ width: "100%" }), t = $('<div class="property-page-fullwidth-wrapper">').append(e), o = this.createColorPicker(), i = this.createFontEditor(), n = $("<tr>").appendTo(this._table), $("<td>").css({ width: "0"
      }).html($.t("Text")).appendTo(n), $('<td colspan="2">').append(t).appendTo(n), n = this.addLabeledRow(this._table, $.t("Text Font")), n.children().css({ whiteSpace: "nowrap" }), $("<td>").append(o).appendTo(n).css({ width: "0" }), $("<td>").append(i).appendTo(n), this.bindControl(new l(o, this._linetool.properties().color, !0, this.model(), "Change Arrow Mark Text Color")), this.bindControl(new r(e, this._linetool.properties().text, null, !0, this.model(), "Change Arrow Mark Text")), this.bindControl(new p(i, this._linetool.properties().font, null, !0, this.model(), "Change Arrow Mark Font")), this.loadData(), setTimeout(function () {
        e.select(), e.focus();
      }, 20);
    }, i.prototype.widget = function () {
      return this._table;
    }, e.exports = i;
  }, 1087: function _(e, t, o) {
    "use strict";
    function i(e, t, o) {
      n.call(this, e, t, o), this.prepareLayout();
    }var n = o(1195),
        ...
        s = o(1201).TabOpenFrom;inherit(i, n), i.prototype.prepareLayout = function () {
      var e,
          t,
          o,
          i,
    ...
    function i(e, t, o) {
      n.call(this, e, t, o), this.prepareLayout();
        ...
        d = o(1196).createLineWidthEditor;inherit(i, n), i.prototype.prepareLayout = function () {
      var e, t, o, i, n, a, h, c;this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">'), e = d(), t = this.createColorPicker(), o = $('<input type="checkbox" class="visibility-switch">'), i = this.createColorPicker(), n = this.addLabeledRow(this._table, "Line"), $("<td>").prependTo(n), $("<td>").append(t).appendTo(n), $("<td>").append(e).appendTo(n), n = this.addLabeledRow(this._table, "Background", o), $("<td>").append(o).prependTo(n), $("<td>").append(i).appendTo(n), a = $("<tbody>").appendTo(this._table), h = $("<select><option value='0'>" + $.t("Normal") + "</option><option value='1'>" + $.t("Arrow") + "</option></select>"), c = $("<select><option value='0'>" + $.t("Normal") + "</option><option value='1'>" + $.t("Arrow") + "</option></select>"), n = this.addLabeledRow(a, $.t("Left End")), $("<td>").prependTo(n), $('<td colspan="3">').appendTo(n).append(h), n = this.addLabeledRow(a, $.t("Right End")), $("<td>").prependTo(n), $('<td colspan="3">').appendTo(n).append(c), this.bindControl(new p(t, this._linetool.properties().linecolor, !0, this.model(), "Change Brush Color")), this.bindControl(new r(e, this._linetool.properties().linewidth, !0, this.model(), "Change Brush Line Width")), this.bindControl(new l(o, this._linetool.properties().fillBackground, !0, this.model(), "Change Brush Filling")), this.bindControl(new p(i, this._linetool.properties().backgroundColor, !0, this.model(), "Change Brush Background Color", this._linetool.properties().transparency)), this.bindControl(new s(h, this._linetool.properties().leftEnd, parseInt, !0, this.model(), "Change Trend Line Left End")), this.bindControl(new s(c, this._linetool.properties().rightEnd, parseInt, !0, this.model(), "Change Trend Line Right End")), this.loadData();
    }, i.prototype.widget = function () {
      return this._table;
    }, e.exports = i;
  }, 1091: function _(e, t, o) {
    "use strict";
    function i(e, t, o) {
      n.call(this, e, t, o), this.prepareLayout();
    }var n = o(1195),
        ...
        c = o(1201).TabOpenFrom;inherit(i, n), i.prototype.prepareLayout = function () {
      var e,
          t,
          o,
          i,
  ...
  }, 1098: function _(e, t, o) {
    "use strict";
    function i(e, t, o) {
      n.call(this, e, t, o);
    }var n = o(1078);inherit(i, n), e.exports = i;
  }, 1099: function _(e, t, o) {
    "use strict";
    function i(e, t, o) {
      n.call(this, e, t, o), this.prepareLayout();
    }
    var n = o(1195),
        ...
        c = o(1197).createLineStyleEditor,
        b = o(1196).createLineWidthEditor,
        u = o(1198).createTransparencyEditor;inherit(i, n), i.prototype.addLevelEditor = function (e, t, o) {
      var i,
          n,
          a,
          u,
          ...
          w,
          _,
          m = $("<tr>");m.appendTo(this._table), i = $("<td>"), i.appendTo(m), n = $("<input type='checkbox' class='visibility-switch'>"), n.appendTo(i), e ? (a = $("<td>"), a.appendTo(m), u = $("<input type='text'>"), u.appendTo(a), u.css("width", "70px"), this.bindControl(new r(u, t.coeff, !1, this.model(), "Change Pitchfork Line Coeff"))) : this.createLabeledCell("Trend Line", n).appendTo(m), C = $("<td class='colorpicker-cell'>"), C.appendTo(m), y = h(C), g = $("<td>"), g.appendTo(m), T = b(), T.appendTo(g), e || (w = $("<td>"), w.appendTo(m), _ = c(), _.render().appendTo(w), this.bindControl(new l(_, t.linestyle, parseInt, !0, this.model(), "Change Fib Circle Style"))), this.bindControl(new p(n, t.visible, !0, this.model(), "Change Fib Circle Visibility")), this.bindControl(new s(y, t.color, !0, this.model(), "Change Fib Circle Line Color", 0)), this.bindControl(new d(T, t.linewidth, !0, this.model(), "Change Fib Circle Width"));
    }, i.prototype.prepareLayout = function () {
      var e, t, o, i, n, a, r;for (this._table = $(document.createElement("table")), this._table.addClass("property-page"), this._table.attr("cellspacing", "0"), this._table.attr("cellpadding", "2"), this.addLevelEditor(null, this._linetool.properties().trendline, !1), e = 1; e <= 11; e++) {
    ...
    function i(e, t, o) {
      n.call(this, e, t, o), this.prepareLayout();
        ...
        h = o(1196).createLineWidthEditor,
        c = o(1198).createTransparencyEditor;inherit(i, n), i.prototype.addLevelEditor = function (e, t, o) {
      var i,
          n,
          a,
          c,
          ...
          C,
          y,
          g = $("<tr>");g.appendTo(this._table), i = $("<td>"), i.appendTo(g), n = $("<input type='checkbox' class='visibility-switch'>"), n.appendTo(i), e ? (a = $("<td>"), a.appendTo(g), c = $("<input type='text'>"), c.appendTo(a), c.css("width", "70px"), this.bindControl(new r(c, t.coeff, !1, this.model(), "Change Pitchfork Line Coeff"))) : this.createLabeledCell("Trend Line", n).appendTo(g), b = $("<td class='colorpicker-cell'>"), b.appendTo(g), u = d(b), C = $("<td>"), C.appendTo(g), y = h(), y.appendTo(C), this.bindControl(new l(n, t.visible, !0, this.model(), "Change Fib Wedge Visibility")), this.bindControl(new p(u, t.color, !0, this.model(), "Change Fib Wedge Line Color", 0)), this.bindControl(new s(y, t.linewidth, !0, this.model(), "Change Fib Wedge Width"));
    }, i.prototype.prepareLayout = function () {
      var e, t, o, i, n, a;for (this._table = $(document.createElement("table")), this._table.addClass("property-page"), this._table.attr("cellspacing", "0"), this._table.attr("cellpadding", "2"), this.addLevelEditor(null, this._linetool.properties().trendline, !1), e = 1; e <= 11; e++) {
        t = "level" + e, this.addLevelEditor("Level " + e, this._linetool.properties()[t], !1);
      }this.addOneColorPropertyWidget(this._table), o = $("<input type='checkbox' class='visibility-switch'>"), i = this.addLabeledRow(this._table, "Levels", o), $("<td>").append(o).prependTo(i), this.bindControl(new l(o, this._linetool.properties().showCoeffs, !0, this.model(), "Change Fib Wedge Levels Visibility")), i = $("<tr>"), i.appendTo(this._table), n = $("<input type='checkbox' class='visibility-switch'>"), $("<td>").append(n).appendTo(i), this.createLabeledCell("Background", n).appendTo(i), a = c(), $('<td colspan="3">').append(a).appendTo(i), this.bindControl(new l(n, this._linetool.properties().fillBackground, !0, this.model(), "Change Wedge Background Visibility")), this.bindControl(new s(a, this._linetool.properties().transparency, !0, this.model(), "Change Wedge Background Transparency")), this.loadData();
    }, i.prototype.widget = function () {
      return this._table;
    }, e.exports = i;
  }, 1105: function _(e, t, o) {
    "use strict";
    function i(e, t, o) {
      n.call(this, e, t, o), this.prepareLayout();
    }var n = o(1195),
    ...
    function i(e, t, o) {
      n.call(this, e, t, o), this.prepareLayout();
        ...
        y = o(1198).createTransparencyEditor;o(241), inherit(i, n), i.prototype.addOneColorPropertyWidget = function (e) {
      var t = this.createOneColorForAllLinesWidget(),
          o = $("<tr>");o.append($("<td>")).append($("<td>")).append(t.editor).append($("<td>").append(t.label)), o.appendTo(e);
    }, i.prototype.prepareLayout = function () {
      var e, t, o, i, n, a, g, T, w, _, m, f, L, v, k, S, P, x, B, R, E, F, I, D, A, W, V, O, z, M, j, H, G, N, U, q, Y, K, Q, J, Z;this._table = $(document.createElement("table")), this._table.addClass("property-page property-page-unpadded"), this._table.attr("cellspacing", "0"), this._table.attr("cellpadding", "2"), this._table.css({ width: "100%" }), e = $("<tr>"), e.appendTo(this._table), t = this.model(), o = this._linetool, i = o.properties(), n = $("<table>"), $("<td valign='top'>").append(n).appendTo(e), a = $("<tr>"), $("<td colspan='3'>" + $.t("Levels") + "</td>").appendTo(a), a.appendTo(n);for (g in i.levels._childs) {
        T = i.levels[g], w = $("<tr>"), w.appendTo(n), $("<td>" + g + "</td>").appendTo(w), _ = $("<input type='checkbox' class='visibility-switch'>"), $("<td>").append(_).appendTo(w), m = $("<td class='colorpicker-cell'>"), m.appendTo(w), f = u(m), L = $("<td>"), L.appendTo(w), v = C(), v.appendTo(L), this.bindControl(new s(_, T.visible, !0, t, "Change Gann Line Visibility")), this.bindControl(new h(f, T.color, !0, t, "Change Gann Line Color", 0)), this.bindControl(new d(v, T.width, !0, t, "Change Gann Line Width"));
      }k = $("<table>"), $("<td valign='top'>").append(k).appendTo(e), S = $("<tr>"), $("<td colspan='4'>" + $.t("Fans") + "</td>").appendTo(S), S.appendTo(k);for (g in i.fanlines._childs) {
        P = i.fanlines[g], x = $("<tr>"), x.appendTo(k), _ = $("<input type='checkbox' class='visibility-switch'>"), $("<td>").append(_).appendTo(x), B = P.x.value() + "x" + P.y.value(), $("<td>" + B + "</td>").appendTo(x), m = $("<td class='colorpicker-cell'>"), m.appendTo(x), f = u(m), L = $("<td>"), L.appendTo(x), v = C(), v.appendTo(L), this.bindControl(new s(_, P.visible, !0, t, "Change Gann Line Visibility")), this.bindControl(new h(f, P.color, !0, t, "Change Gann Fan Color", 0)), this.bindControl(new d(v, P.width, !0, t, "Change Gann Line Width"));
      }R = $("<table>"), $("<td valign='top'>").append(R).appendTo(e), E = $("<tr>"), $("<td colspan='4'>" + $.t("Arcs") + "</td>").appendTo(E), E.appendTo(R);for (g in i.arcs._childs) {
        F = i.arcs[g], I = $("<tr>"), I.appendTo(R), _ = $("<input type='checkbox' class='visibility-switch'>"), $("<td>").append(_).appendTo(I), B = F.x.value() + "x" + F.y.value(), $("<td>" + B + "</td>").appendTo(I), m = $("<td class='colorpicker-cell'>"), m.appendTo(I), f = u(m), L = $("<td>"), L.appendTo(I), v = C(), v.appendTo(L), this.bindControl(new s(_, F.visible, !0, t, "Change Gann Line Visibility")), this.bindControl(new h(f, F.color, !0, t, "Change Gann Arc Color", 0)), this.bindControl(new d(v, F.width, !0, t, "Change Gann Line Width"));
      }this.addOneColorPropertyWidget(R), D = $("<tbody>").appendTo(this._table), A = $('<input type="checkbox" class="visibility-switch">'), W = y(), V = $("<tr>").appendTo(D), O = $("<table>"), $('<td colspan="3">').append(O).appendTo(V), V = $("<tr>").appendTo(O), $("<td>").append(A).appendTo(V), $("<td>" + $.t("Background") + "</td>").appendTo(V), $("<td>").append(W).appendTo(V), i.reverse && (z = $("<input type='checkbox' class='visibility-switch'>"), V = this.addLabeledRow(O, $.t("Reverse"), z, !0), $("<td>").append(z).prependTo(V), M = "Change Gann Square Reverse", this.bindControl(new s(z, i.reverse, !0, t, M))), this.bindControl(new s(A, i.arcsBackground.fillBackground, !0, t, "Change Gann Square Filling")), this.bindControl(new d(W, i.arcsBackground.transparency, !0, t, "Change Gann Square Background Transparency")), j = $('<input type="text">'), V = this.addLabeledRow(O, $.t("Price/Bar Ratio"), j, !0), $("<td>").append(j).appendTo(V), j.TVTicker({ step: o.getScaleRatioStep() }), M = "Change Gann Square Scale Ratio", H = this._getPropertySetter(i.scaleRatio, M), G = [p(i.scaleRatio.value()), l(1e-7), r(1e8)], N = new b(j, i.scaleRatio, G, !1, t, M, H), N.addFormatter(function (e) {
        return o.getScaleRatioFormatter().format(e);
      }), this.bindControl(N), U = $('<input type="checkbox">'), V = this.addLabeledRow(O, $.t("Ranges And Ratio"), U, !1), $("<td>").append(U).prependTo(V), this.bindControl(new s(U, i.showLabels, !0, t, "Change Gann Square Lables Visibility")), v = C(), f = this.createColorPicker(), q = $('<span class="_tv-button _tv-button-fontstyle"><span class="icon-fontstyle-bold"></span></span>'), Y = $('<span class="_tv-button _tv-button-fontstyle"><span class="icon-fontstyle-italic"></span></span>'), K = this.createFontSizeEditor(), Q = this.createFontEditor(), J = i.labelsStyle, this.bindControl(new c(K, J.fontSize, parseInt, !0, t, "Change Text Font Size")), this.bindControl(new c(Q, J.font, null, !0, t, "Change Text Font")), this.bindControl(new s(q, J.bold, !0, t, "Change Text Font Bold")), this.bindControl(new s(Y, J.italic, !0, t, "Change Text Font Italic")), Z = $('<table class="property-page" cellspacing="0" cellpadding="2"><tr>').append($(document.createElement("td")).attr({ width: 1 }).append(Q)).append($(document.createElement("td")).attr({ width: 1 }).append(K)).append($(document.createElement("td")).css("vertical-align", "top").attr({ width: 1 }).append(q)).append($(document.createElement("td")).css("vertical-align", "top").append(Y)).append($("</tr></table>")), $('<td colspan="5" class="no-left-indent">').append(Z).appendTo(V);
    }, i.prototype.widget = function () {
      return this._table;
    }, i.prototype._getPropertySetter = function (e, t) {
      var o = this.model(),
          i = this._linetool;return function (n) {
        o.beginUndoMacro(t), o.saveLineToolState(i, "Save Gann Square State"), o.setProperty(e, n, t), o.saveLineToolState(i, "Save Gann Square State"), o.endUndoMacro();
      };
    ...
    function i(e, t, o) {
      n.call(this, e, t, o), this.prepareLayout();
        ...
        h = o(1198).createTransparencyEditor;inherit(i, n), i.prototype.addOneColorPropertyWidget = function (e) {
      var t = this.createOneColorForAllLinesWidget(),
          o = $("<tr>");o.append($("<td>")).append($("<td>")).append(t.editor).append($("<td>").append(t.label)), o.appendTo(e);
    }, i.prototype.prepareLayout = function () {
      var e, t, o, i, n, a, c, b, u, C, y, g, T, w, _, m, f, L, v, k, S, P, x, B, R, E, F;this._table = $(document.createElement("table")), this._table.addClass("property-page property-page-unpadded"), this._table.attr("cellspacing", "0"), this._table.attr("cellpadding", "2"), this._table.css({ width: "100%" }), e = $("<tr>"), e.appendTo(this._table), t = this._linetool.properties(), o = $("<table>"), $("<td valign='top'>").append(o).appendTo(e), i = $("<tr>"), $("<td colspan='3'>" + $.t("Levels") + "</td>").appendTo(i), i.appendTo(o);for (n in t.levels._childs) {
        a = t.levels[n], c = $("<tr>"), c.appendTo(o), $("<td>" + n + "</td>").appendTo(c), b = $("<input type='checkbox' class='visibility-switch'>"), $("<td>").append(b).appendTo(c), u = $("<td class='colorpicker-cell'>"), u.appendTo(c), C = s(u), y = $("<td>"), y.appendTo(c), g = d(), g.appendTo(y), this.bindControl(new r(b, a.visible, !0, this.model(), "Change Gann Line Visibility")), this.bindControl(new p(C, a.color, !0, this.model(), "Change Gann Line Color", 0)), this.bindControl(new l(g, a.width, !0, this.model(), "Change Gann Line Width"));
      }T = $("<table>"), $("<td valign='top'>").append(T).appendTo(e), w = $("<tr>"), $("<td colspan='4'>" + $.t("Fans") + "</td>").appendTo(w), w.appendTo(T);for (n in t.fanlines._childs) {
        _ = t.fanlines[n], m = $("<tr>"), m.appendTo(T), b = $("<input type='checkbox' class='visibility-switch'>"), $("<td>").append(b).appendTo(m), f = _.x.value() + "x" + _.y.value(), $("<td>" + f + "</td>").appendTo(m), u = $("<td class='colorpicker-cell'>"), u.appendTo(m), C = s(u), y = $("<td>"), y.appendTo(m), g = d(), g.appendTo(y), this.bindControl(new r(b, _.visible, !0, this.model(), "Change Gann Line Visibility")), this.bindControl(new p(C, _.color, !0, this.model(), "Change Gann Fan Color", 0)), this.bindControl(new l(g, _.width, !0, this.model(), "Change Gann Line Width"));
      }L = $("<table>"), $("<td valign='top'>").append(L).appendTo(e), v = $("<tr>"), $("<td colspan='4'>" + $.t("Arcs") + "</td>").appendTo(v), v.appendTo(L);for (n in t.arcs._childs) {
        k = t.arcs[n], S = $("<tr>"), S.appendTo(L), b = $("<input type='checkbox' class='visibility-switch'>"), $("<td>").append(b).appendTo(S), f = k.x.value() + "x" + k.y.value(), $("<td>" + f + "</td>").appendTo(S), u = $("<td class='colorpicker-cell'>"), u.appendTo(S), C = s(u), y = $("<td>"), y.appendTo(S), g = d(), g.appendTo(y), this.bindControl(new r(b, k.visible, !0, this.model(), "Change Gann Line Visibility")), this.bindControl(new p(C, k.color, !0, this.model(), "Change Gann Arc Color", 0)), this.bindControl(new l(g, k.width, !0, this.model(), "Change Gann Line Width"));
      }this.addOneColorPropertyWidget(L), P = $("<tbody>").appendTo(this._table), x = $('<input type="checkbox" class="visibility-switch">'), B = h(), R = $("<tr>").appendTo(P), E = $("<table>"), $('<td colspan="3">').append(E).appendTo(R), R = $("<tr>").appendTo(E), $("<td>").append(x).appendTo(R), $("<td>" + $.t("Background") + "</td>").appendTo(R), $("<td>").append(B).appendTo(R), t.reverse && (F = $("<input type='checkbox' class='visibility-switch'>"), R = this.addLabeledRow(E, $.t("Reverse"), F, !0), $("<td>").append(F).prependTo(R), this.bindControl(new r(F, t.reverse, !0, this.model(), "Change Gann Square Reverse"))), this.bindControl(new r(x, t.arcsBackground.fillBackground, !0, this.model(), "Change Gann Square Filling")), this.bindControl(new l(B, t.arcsBackground.transparency, !0, this.model(), "Change Gann Square Background Transparency"));
    }, i.prototype.widget = function () {
      return this._table;
    ...
    function i(e, t, o) {
      n.call(this, e, t, o), this.prepareLayout();
        ...
        c = o(1196).createLineWidthEditor,
        b = o(1198).createTransparencyEditor;inherit(i, n), i.prototype.addLevelEditor = function (e, t, o, i) {
      var n,
          a,
          b,
          u,
      ...
      var e,
          ...
          u = $('<table class="property-page" cellspacing="0" cellpadding="2">');for (this._tbody = $("<tbody>").appendTo(c), e = 1; e <= 9; e++) {
        t = "level" + e, o = this._linetool.properties()[t], i = o.coeff1.value(), n = o.coeff2.value(), a = "<sup>" + i + "</sup>&frasl;<sub>" + n + "</sub>", this.addLevelEditor(a, o, i, n);
    ...
    var n = o(1195),
        ...
        s = a.SliderBinder,
        d = o(372).addColorPicker,
        h = o(1198).createTransparencyEditor;inherit(i, n), i.prototype.addLevelEditor = function (e, t, o) {
      var i,
          n,
          a,
          s,
      ...
      var t,
          o,
          i = $("<tr>").appendTo(e),
          n = $("<input type='checkbox' class='visibility-switch'>");n.appendTo($("<td>").appendTo(i)), $("<td>" + $.t("Angles") + "</td>").appendTo(i), t = $("<td class='colorpicker-cell'>").appendTo(i), o = d(t), this.bindControl(new r(n, this._linetool.properties().fans.visible, !0, this.model(), "Change Gann Square Angles Visibility")), this.bindControl(new p(o, this._linetool.properties().fans.color, !0, this.model(), "Change Gann Square Angles Color", 0));
    }, i.prototype.prepareLayout = function () {
      var e, t, o, i, n, a, l, p, d, c, b, u, C, y, g, T, w, _, m, f;for (this._table = $(document.createElement("table")), this._table.addClass("property-page property-page-unpadded"), this._table.attr("cellspacing", "0"), this._table.attr("cellpadding", "2"), this._table.css({ width: "100%" }), e = $("<tbody>").appendTo(this._table), t = $("<tr>"), t.appendTo(e), o = $('<td width="50%">'), o.appendTo(t), i = $('<td width="50%">'), i.appendTo(t), n = $('<table cellspacing="0" cellpadding="2">'), n.appendTo(o), n.addClass("property-page"), a = $('<table cellspacing="0" cellpadding="2">'), a.appendTo(i), a.addClass("property-page"), $("<tr><td align='center' colspan='4'>" + $.t("Price Levels") + "</td></tr>").appendTo(n), $("<tr><td align='center' colspan='4'>" + $.t("Time Levels") + "</td></tr>").appendTo(a), l = 1; l <= 7; l++) {
    ...
    function i(e, t, o) {
      n.call(this, e, t, o), this.prepareLayout();
        ...
        a = o(238).ColorBinding;inherit(i, n), i.prototype.prepareLayout = function () {
    ...
    function i(e, t, o) {
      a.call(this, e, t, o), this.prepareLayout();
        ...
        d = r.BooleanBinder,
        h = o(76);inherit(i, a), i.prototype.prepareLayout = function () {
      var e,
          t,
          o,
          i,
    ...
    function i(e, t, o) {
      ...
      var i,
          ...
          w,
          _,
          m = $("<tr>");m.appendTo(this._table), e ? (i = $("<td>"), i.appendTo(m), n = $("<input type='checkbox' class='visibility-switch'>"), n.appendTo(i), a = $("<td>"), a.appendTo(m), u = $("<input type='text'>"), u.appendTo(a), u.css("width", "70px"), this.bindControl(new r(n, t.visible, !0, this.model(), "Change Pitchfork Line Visibility")), this.bindControl(new l(u, t.coeff, !1, this.model(), "Change Pitchfork Line Coeff"))) : $("<td colspan='2'>" + $.t("Median") + "</td>").appendTo(m), C = $("<td class='colorpicker-cell'>"), C.appendTo(m), y = h(C), g = $("<td>"), g.appendTo(m), T = b(), T.appendTo(g), w = $("<td>"), w.appendTo(m), _ = c(), _.render().appendTo(w), this.bindControl(new p(y, t.color, !0, this.model(), "Change Pitchfork Line Color"), 0), this.bindControl(new s(_, t.linestyle, parseInt, !0, this.model(), "Change Pitchfan Line Style")), this.bindControl(new d(T, t.linewidth, !0, this.model(), "Change Pitchfan Line Width"));
    }, i.prototype.prepareLayout = function () {
      var e, t, o, i, n;for (this._table = $(document.createElement("table")), this._table.addClass("property-page"), this._table.attr("cellspacing", "0"), this._table.attr("cellpadding", "2"), this.addLevelEditor(null, this._linetool.properties().median, !1), e = 0; e <= 8; e++) {
    ...
    function i(e, t, o) {
      n.call(this, e, t, o), this.prepareLayout();
        ...
        c = o(1197).createLineStyleEditor,
        b = o(1196).createLineWidthEditor,
        u = o(1198).createTransparencyEditor;inherit(i, n), i.prototype.onResoreDefaults = function () {
      ...
      var e, t, o, i, n, a;for (this._table = $(document.createElement("table")), this._table.addClass("property-page"), this._table.attr("cellspacing", "0"), this._table.attr("cellpadding", "2"), this.addLevelEditor(null, this._linetool.properties().median, !1), e = 0; e <= 8; e++) {
        t = "level" + e, this.addLevelEditor($.t("Level {0}").format(e + 1), this._linetool.properties()[t], !1);
    ...
    var n = o(1195),
        ...
        r = a.ColorBinding,
        l = a.SliderBinder,
        p = o(1196).createLineWidthEditor;inherit(i, n), i.prototype.prepareLayout = function () {
      var e,
          t,
          o,
          i,
    ...
    function i(e, t, o) {
      n.call(this, e, t, o), this.prepareLayout();
        ...
        a = o(238),
        r = a.SimpleComboBinder,
        l = a.ColorBinding;inherit(i, n), i.prototype.prepareLayout = function () {
    ...
    function i(e, t) {
      ...
      var o,
          ...
          b = this._model._chartWidget;return $.each(b.paneWidgets(), function (e, t) {
        if (t._state === c) return d = $(t.canvas).offset().top, !1;
      }), e || (e = {}), i = e.left, n = e.top, a = (this._linetool.paneViews() || [])[0], a && (o = a._floatPoints[0]), o && (i = o.x, n = o.y + d), r = $(t).outerHeight(), l = $(window).height(), p = h.properties().fontsize.value(), n = n + r + p + s <= l ? n + p + s : n - r - s, { top: n, left: i };
    }, e.exports = n;
  }, 1122: function _(e, t, o) {
    "use strict";
    function i(e, t, o) {
      n.call(this, e, t, o), this.prepareLayout();
    }var n = o(1195),
    ...
    function i(e, t, o) {
      n.call(this, e, t), this._linetool = o, this.prepareLayout();
        ...
        r = o(1076),
        l = o(33),
        p = o(1201);inherit(i, r), i.prototype.prepareLayout = function () {
      var e,
          t,
          o,
          i,
          ...
          c = $('<table class="property-page" cellspacing="0" cellpadding="0">').data({ "layout-tab": p.TabNames.inputs, "layout-tab-priority": p.TabPriority.Inputs });for (this._table = h.add(c), e = this._linetool.points(), t = 0; t < e.length; t++) {
        o = $("<tr>"), o.appendTo(h), i = $("<td>"), i.html("Point " + (t + 1) + " Bar #"), i.appendTo(o), n = $("<td>"), n.appendTo(o), r = $("<input type='text'>"), r.appendTo(n), r.addClass("ticker"), s = this._linetool.properties().points[t], this.bindBarIndex(s.bar, r, this.model(), "Change " + this._linetool + " point bar index");
    ...
    function i(e, t, o) {
      r.call(this, e, t), this._study = o, this.prepareLayout();
        ...
        d = o(49);inherit(i, r), inherit(i, n), i.prototype._isJapaneseChartsAvailable = function () {
      return !1;
    }, i.prototype.prepareLayout = function () {
      var e,
          t,
          ...
          c = this._study.properties();this._prepareSeriesStyleLayout(n, a, r, c), this._table = n.add(a).add(r).add(d).add(h), e = $('<input type="checkbox">'), t = this.addLabeledRow(d, "Price Line", e), $("<td>").append(e).prependTo(t), this.bindControl(new l(e, c.showPriceLine, !0, this.model(), "Change Price Price Line")), o = this.createSeriesMinTickEditor(), i = $("<tr>"), i.appendTo(h), $("<td>" + $.t("Override Min Tick") + "</td>").appendTo(i), $("<td>").append(o).appendTo(i), this.bindControl(new p(o, c.minTick, null, !0, this.model(), "Change MinTick")), s.prototype._putStudyDefaultStyles.call(this, h);
    }, i.prototype.loadData = function () {
      this.superclass.prototype.loadData.call(this), this.switchStyle();
    }, i.prototype.switchStyle = function () {
      switch ($(this._barsTbody).add(this._barsColorerTbody).add(this._candlesTbody).add(this._candlesColorerTbody).add(this._hollowCandlesTbody).add(this._lineTbody).add(this._areaTbody).add(this._baselineTbody).css("display", "none"), this._study.properties().style.value()) {case d.STYLE_BARS:
          this._barsTbody.css("display", "table-row-group"), this._barsColorerTbody.css("display", "table-row-group");break;case d.STYLE_CANDLES:
          this._candlesTbody.css("display", "table-row-group"), this._candlesColorerTbody.css("display", "table-row-group");break;case d.STYLE_HOLLOW_CANDLES:
          this._hollowCandlesTbody.css("display", "table-row-group");break;case d.STYLE_LINE:
          this._lineTbody.css("display", "table-row-group");break;case d.STYLE_AREA:
          this._areaTbody.css("display", "table-row-group");break;case d.STYLE_BASELINE:
          this._baselineTbody.css("display", "table-row-group");}
    }, i.prototype.widget = function () {
      return this._table;
    }, e.exports = i;
    ...
    function i(e, t, o) {
      a.call(this, e, t), this._study = o, this.prepareLayout();
        ...
        h = o(1196).createLineWidthEditor;inherit(i, a), i.prototype.prepareLayout = function () {
      var e,
          t,
          o,
          i,
        ...
        var n,
            r,
            d,
            c = $("<input type='checkbox' class='visibility-switch'/>");g.bindControl(new l(c, e, !0, g.model(), "Change " + i)), n = g.addLabeledRow(a, i, c), $("<td>").append(c).prependTo(n), r = g.createColorPicker(), $("<td>").append(r).appendTo(n), g.bindControl(new s(r, t, !0, g.model(), "Change " + i + " color")), d = h(), $("<td>").append(d).appendTo(n), g.bindControl(new p(d, o, !0, g.model(), "Change " + i + " width")), g._rows.push({ row: n, label: i, visibilityEditor: c });
      }), y = g._study._properties.inputs.kind, g.lockNotUsedVisEditors(y.value()), y.subscribe(g, function (e) {
      ...
      var t,
          ...
          i,
          n,
          a = this;for (t = 0; t < a._rows.length; t++) {
        o = a._rows[t], i = o.label, n = a.pivotTypes[e][i], o.visibilityEditor.prop("disabled", !n), o.row.css("opacity", n ? 1 : .5);
      }
    }, i.prototype.widget = function () {
      return this._table;
    }, e.exports = i;
    ...
    function i(e, t, o) {
      r.call(this, e, t), this._study = o, this.prepareLayout();
        ...
        c = a.SimpleComboBinder,
        b = a.SimpleStringBinder,
        u = o(89).NumericFormatter;inherit(i, r), i.prototype._getStrategyInputs = function () {
      for (var e, t = 0, o = this._study.metaInfo(), i = {}; t < o.inputs.length; t++) {
        e = o.inputs[t], "strategy_props" === e.groupId && (n(void 0 !== e.internalID, "Strategy input id=" + e.id + " doesn't have an internalID"), i[e.internalID] = o.inputs[t]);
      }return TradingView.clone(i);
    }, i.prototype._setStdInput = function (e, t, o) {
      var i, n, a, r, C, y, g, T, w, _, m, f;if (e) {
        if (i = e.id, n = "study_input-" + i + "-" + Date.now().toString(36) + "-" + Math.random().toString(36), a = $("<tr>").appendTo(this._$table), r = "Change " + t, C = $('<label for="' + n + '">' + $.t(t, { context: "input" }) + "</label>"), "bool" === e.type) g = $('<td colspan="3">').appendTo(a), y = $('<input id="' + n + '" type="checkbox">').appendTo(g), C.appendTo(g), !0 !== o && this.bindControl(new h(y, this._property.inputs[i], !0, this.model(), r));else if ($("<td>").addClass("propertypage-name-label").append(C).appendTo(a), T = $('<td colspan="2">').appendTo(a), e.options) {
          for (y = $('<select id="' + n + '">').appendTo(T), w = 0; w < e.options.length; w++) {
            _ = e.options[w], _ instanceof jQuery ? _.appendTo(y) : $('<option value="' + _ + '">' + _ + "</option>").appendTo(y);
          }!0 !== o && this.bindControl(new c(y, this._property.inputs[i], null, !0, this.model(), r));
        } else y = $('<input id="' + n + '" type="text">').appendTo(T), !0 !== o && ("integer" !== e.type && "float" !== e.type || (m = ["integer" === e.type ? s(e.defval) : d(e.defval)], (0 === e.min || e.min) && m.push(l(e.min)), (0 === e.max || e.max) && m.push(p(e.max))), f = new b(y, this._property.inputs[i], m, !1, this.model(), r), "float" === e.type && f.addFormatter(function (e) {
          return new u().format(e);
        }), this.bindControl(f)), y.addClass("ticker");return y;
      }
      ...
      var t = e.pyramiding,
          ...
          r = a.closest("tr");n(void 0 === this._onAllowUpToChanged), this._onAllowUpToChanged = function (e) {
        ...
        var e = !i.prop("checked");o.setValue(e ? 0 : t.defval), e ? a.attr("disabled", "disabled") : a.removeAttr("disabled"), r.toggleClass("disabled", e);
      ...
      var n,
          a = this._study.reportData() && this._study.reportData().currency || "USD";i && (a += i), e.text(a), n = t.closest("td"), n.find("a[href=#" + o + "]").text(a), e.prop("selected") && n.find(".sbSelector").text(a);
      ...
      var t = this._setStdInput(e.backtest_fill_limits_assumption, $.t("Verify Price for Limit Orders")),
          o = t.closest("td");o.removeAttr("colSpan"), $("<td>").text($.t("ticks", { context: "slippage ... ticks" })).insertAfter(o);
    }, i.prototype._setSlippageInputs = function (e) {
      var t, o;void 0 !== e.slippage && (t = this._setStdInput(e.slippage, $.t("Slippage")), o = t.closest("td"), o.removeAttr("colSpan"), $("<td>").text($.t("ticks", { context: "slippage ... ticks" })).insertAfter(o));
    }, i.prototype._setCommissionInputs = function (e) {
      function t(e) {
        return e = +e, isNaN(e) || e < 0 ? 0 : ("percent" !== c.val() ? e = parseFloat(e) : e > 100 && (e = 100), e);
      }var o, i, n, a, r, l, p, s, d, h, c, u, C;void 0 !== e.commission_value && void 0 !== e.commission_type && (o = this, i = e.commission_value, n = $.extend({}, e.commission_type), a = this._property.inputs[i.id], r = this._setStdInput(i, $.t("Commission"), !0), l = new b(r, a, t, !1, this.model(), "Change Commission value"), this.bindControl(l), p = r.closest("td"), p.removeAttr("colspan"), s = this._study.reportData() && this._study.reportData().currency || "USD", d = $('<option value="cash_per_order">' + s + $.t(" per order") + "</option>"), h = $('<option value="cash_per_contract">' + s + $.t(" per contract") + "</option>"), n.options = [$('<option value="percent">' + $.t("%") + "</option>"), d, h], c = this._setStdInput(n, "type"), u = c.closest("td"), C = u.closest("tr"), u.removeAttr("colspan"), u.detach().insertAfter(p), C.remove(), this._study.watchedData.subscribe(function () {
      ...
      var e, t, o;r.prototype.loadData.call(this), e = this._getStrategyInputs(), t = e.pyramiding, o = this._property.inputs[t.id], o.setValue(o.value(), !0);
    }, i.prototype.destroy = function () {
      var e, t, o;r.prototype.destroy.call(this), e = this._getStrategyInputs(), t = e.pyramiding, o = this._property.inputs[t.id], o.unsubscribe(null, this._onAllowUpToChanged);
    }, e.exports = i;
    ...
    function i(e, t, o) {
      a.call(this, e, t), this._study = o, this.prepareLayout();
        ...
        s = n.ColorBinding,
        d = o(1196).createLineWidthEditor,
        h = o(1235).createPlotEditor;inherit(i, a), i.prototype.prepareLayout = function () {
      var e,
          t,
          i,
          n,
    ...
    function i(e) {
      function t(t, o, i) {
        ...
        var t = this;return e = $.extend({}, e, { getDataForSaveAs: function getDataForSaveAs() {
      ...
      r.call(this, e, t), this._linetool = o;
        ...
        s = o(385);inherit(n, r), n.prototype.createOneColorForAllLinesWidget = function () {
      var e = $("<td class='colorpicker-cell'>");return this.bindControl(new l(p(e), this._linetool.properties().collectibleColors, !0, this.model(), "Change All Lines Color", 0)), { label: $("<td>" + $.t("Use one color") + "</td>"), editor: e };
    }, n.prototype.addOneColorPropertyWidget = function (e) {
      var t = this.createOneColorForAllLinesWidget(),
          o = $("<tr>");o.append($("<td>")).append(t.label).append(t.editor), o.appendTo(e);
    ...
    "use strict";
    function i() {
      return new n.Combobox([{ html: '<div class="tv-line-style-option tv-line-style-option--solid"/>', value: a.LINESTYLE_SOLID }, { html: '<div class="tv-line-style-option tv-line-style-option--dotted"/>', value: a.LINESTYLE_DOTTED }, { html: '<div class="tv-line-style-option tv-line-style-option--dashed"/>', value: a.LINESTYLE_DASHED }]);
    }var n, a;Object.defineProperty(t, "__esModule", { value: !0 }), n = o(1259), a = o(240), t.createLineStyleEditor = i;
  }, 1198: function _(e, t, o) {
    "use strict";
    function i(e) {
      var t = $('<div class="transparency-slider"><div class="gradient"></div></div>').slider({ max: 100, min: 0, step: 1 }),
          o = ["-moz-linear-gradient(left, %COLOR 0%, transparent 100%)", "-webkit-gradient(linear, left top, right top, color-stop(0%,%COLOR), color-stop(100%,transparent))", "-webkit-linear-gradient(left, %COLOR 0%,transparent 100%)", "-o-linear-gradient(left, %COLOR 0%,transparent 100%)", "linear-gradient(to right, %COLOR 0%,transparent 100%)"];return t.updateColor = function (e) {
        var i = t.find(".gradient");o.forEach(function (t) {
  ...
  }, 1234: function _(e, t, o) {
    "use strict";
    (function (t) {
      function i() {}var n = o(238),
          a = n.PropertyPage,
          r = n.GreateTransformer,
          l = n.LessTransformer,
          p = n.ToIntTransformer,
        ...
        }var c, b, u, C, y, g, w, _, m, f, L, v, k, S, P, x, B, R;for (i = i || {}, c = {}, b = this, u = 0; u < e.inputs.length; u++) {
          C = e.inputs[u], y = C.id, w = "BarSetRenko@tv-prostudies" === e.name || "BarSetKagi@tv-prostudies" === e.name || "BarSetPriceBreak@tv-prostudies" === e.name, "BarSetPnF@tv-prostudies" === e.name && "sources" === y && (C.options = C.options.filter(function (e) {
            return "HL" === e || "Close" === e;
          }));try {
            ...
            if (_ = $("<tr/>"), C.isHidden || _.appendTo(t), m = $("<td" + (i.nameColspan ? ' colspan = "' + i.nameColspan + '"' : "") + "/>"), m.appendTo(_), m.addClass("propertypage-name-label"), m.text($.t(g)), f = $("<td" + (i.valueColspan ? ' colspan = "' + i.valueColspan + '"' : "") + "/>"), f.appendTo(_), L = null, C.options) for (L = $("<select/>"), v = 0; v < C.options.length; v++) {
              k = C.options[v], $("<option value='" + k + "'>" + $.t(k) + "</option>").appendTo(L);
            } else L = $("<input/>"), "bool" === C.type ? L.attr("type", "checkbox") : L.attr("type", "text");L.appendTo(f), L.css("width", "100px"), S = "Change " + g, C.options ? this.bindControl(new h(L, o.inputs[y], null, !0, this.model(), S)) : "integer" === C.type ? (P = [p(C.defval)], C.min && P.push(r(C.min)), C.max && P.push(l(C.max)), this.bindControl(new d(L, o.inputs[y], P, !1, this.model(), S)), L.addClass("ticker")) : "float" === C.type ? (P = [s(C.defval)], C.min && ((("BarSetRenko@tv-prostudies" === e.id || "BarSetPnF@tv-prostudies" === e.id) && "boxSize" === C.id || "BarSetKagi@tv-prostudies" === e.id && "reversalAmount" === C.id) && (B = this._model.model().mainSeries().symbolInfo(), x = B.minmov / B.pricescale), P.push(r(x || C.min))), C.max && P.push(l(C.max)), R = new d(L, o.inputs[y], P, !1, this.model(), S), R.addFormatter(a), this.bindControl(R), L.addClass("ticker")) : "text" === C.type && this.bindControl(new d(L, this._property.inputs[y], null, !1, this.model(), S)), L.change(n), c[C.id] = _;
          }
        }this.refreshStateControls(c, e.inputs, o.inputs);
      }, i.prototype.getMetaInfo = function (e) {
        var t,
            o = this._model.m_model._studiesMetaData;for (t = 0; t < o.length; t++) {
    ...
    }(), t.ComboboxItem = i, n = function () {
      function e(e) {
        var t = this;this._disabled = !1, this._closeCb = null, this.opened = !1, this._value = null, this.items = [], this.width = 0, this._jqWrapper = $('<div class="custom-select">'), this._jqWrapper.data({ disable: this.disable.bind(this), enable: this.enable.bind(this) }), this._jqWrapper.selectable(!1), this._jqSwitcher = $('<div class="switcher">').appendTo(this._jqWrapper), this._jqSwitcher.on("click", function () {
          t.toggleItems();
        }), this._jqTitle = $('<span class="title">').appendTo(this._jqSwitcher), $('<span class="icon">').appendTo(this._jqSwitcher), this._jqItems = $('<div class="items js-hidden">').appendTo(this._jqWrapper), this._callback = null, e && this.addItems(e);
      }return e.prototype.toggleItems = function () {
        ...
        var t,
            ...
            i,
            n,
            a = null;for (t = 0, o = this.items; t < o.length; t++) {
          i = o[t], (n = i.selectAndReturnIfValueMatch(e)) && (a = n);
        }return a;
      }, e.prototype.setValue = function (e) {
        if (this._value !== e) {
          var t = this.selectItemByValue(e);t && (this._value = e, this._jqTitle.html(t.html), this.change());
        }
      }, e.prototype.change = function (e) {
        if (e) return void (this._callback = e);this._callback && this._callback.call(this);
      }, e.prototype.value = function () {
        return this._value;
      }, e.prototype.val = function (e) {
        return void 0 !== e ? void this.setValue(e) : this.value();
      }, e.prototype.addItems = function (e) {
        var t, o, i;for (t = 0, o = e; t < o.length; t++) {
          i = o[t], this.addItem(i.value, i.html);
        }
      }, e.prototype.addItem = function (e, t) {
        var o,
            n = this,
            a = new i(e, t);this.items.push(a), o = a.render(), o.on("click", function () {
          n.setValue(e), n.toggleItems();
        }), this._jqItems.append(o), null === this.value() && this.setValue(e);
        ...
        var e = this;this._disabled || (this._jqItems.removeClass("js-hidden"), this._jqSwitcher.addClass("open"), this.opened = !0, this._closeCb || (this._closeCb = { host: this._jqSwitcher.prop("ownerDocument"), cb: function cb(t) {
            e._jqWrapper[0].contains(t.target) || e._close();
          } }, this._closeCb.host.addEventListener("mousedown", this._closeCb.cb, !1)));
      }, e.prototype._close = function () {
        this._jqItems.addClass("js-hidden"), this._jqSwitcher.removeClass("open"), this.opened = !1, this._closeCb && (this._closeCb.host.removeEventListener("mousedown", this._closeCb.cb, !1), this._closeCb = null);
      }, e;
    }(), t.Combobox = n;
  }, 1260: function _(e, t) {}, 1261: function _(e, t) {}, 1262: function _(e, t, o) {
    "use strict";
    function i() {
    ...
    }Object.defineProperty(t, "__esModule", { value: !0 }), o(13), o(12);var n = o(240);t.createShapeLocationEditor = i;
  }, 1263: function _(e, t, o) {
    "use strict";
    function i() {
      var e = "<select>";return Object.keys(n.plotShapesData).forEach(function (t) {
        var o = n.plotShapesData[t];e += '<option value="' + o.id + '">' + o.guiName + "</option>";
      }), e += "</select>", $(e);
    }Object.defineProperty(t, "__esModule", { value: !0 }), o(13);var n = o(111);t.createShapeStyleEditor = i;
  }, 1264: function _(e, t, o) {
    "use strict";
    function i() {
  ...
  }, 1265: function _(e, t, o) {
    "use strict";
    function i() {
      var e = $("<select />");return $('<option value="' + n.HHISTDIR_LEFTTORIGHT + '">' + $.t("Left") + "</option>").appendTo(e), $('<option value="' + n.HHISTDIR_RIGHTTOLEFT + '">' + $.t("Right") + "</option>").appendTo(e), e;
    }Object.defineProperty(t, "__esModule", { value: !0 }), o(13), o(12);var n = o(240);t.createHHistDirectionEditor = i;
  }, 378: function _(e, t, o) {
    "use strict";
    function i(e, t, o) {
      r.call(this, e, t), this._study = o, this.prepareLayout();
    }function n(e, t, o) {
    ...
    var a = o(238),
      ...
      var o,
        ...
        var e = $(this),
            t = e.val();t && (e.val(t.split("")[t.length - 1]), e.change());
      ...
      var o,
          ...
          l,
          p = null,
          s = this._study;return (!s.properties().linkedToSeries || !s.properties().linkedToSeries.value()) && ($.each(this._model.m_model.panes(), function (e, t) {
        $.each(t.dataSources(), function (e, o) {
          if (o === s) return p = t, !1;
        });
      }), this._pane = p, this._pane && (-1 !== this._pane.leftPriceScale().dataSources().indexOf(this._study) ? o = "left" : -1 !== this._pane.rightPriceScale().dataSources().indexOf(this._study) ? o = "right" : this._pane.isOverlay(this._study) && (o = "none")), o && (i = this, n = { left: $.t("Scale Left"), right: $.t("Scale Right") }, i._pane.actionNoScaleIsEnabled(s) && (n.none = $.t("Screen (No Scale)")), a = this.createKeyCombo(n).val(o).change(function () {
        switch (this.value) {case "left":
            i._model.move(i._study, i._pane, i._pane.leftPriceScale());break;case "right":
            i._model.move(i._study, i._pane, i._pane.rightPriceScale());break;case "none":
      ...
      var a,
          ...
          l,
          p = $('<tr class="line"/>'),
          s = $("<td/>");return s.appendTo(p), a = $("<input type='checkbox' class='visibility-switch'/>"), a.appendTo(s), this.createLabeledCell(i, a).appendTo(p).addClass("propertypage-name-label"), r = $("<td/>"), r.appendTo(p), r.addClass("colorpicker-cell"), l = g(r), this.bindControl(new c(a, e, !0, this.model(), n + " visibility")), this.bindControl(new u(l, t, !0, this.model(), n + " color", o)), p;
    }, inherit(n, r), n.prototype.prepareLayout = function () {
      if (this._study.properties().linkedToSeries && this._study.properties().linkedToSeries.value()) return void (this._table = $());this._table = $();
    }, n.prototype.widget = function () {
      return this._table;
      ...
      var o,
          ...
          g = [],
          T = this.addRow(e),
          w = f();$("<td>").append(w).appendTo(T), this.createLabeledCell(b, w).appendTo(T), this.bindControl(new c(w, t.visible, !0, this.model(), "Change " + b + " Visibility")), T = this.addRow(e), o = $("<input/>"), o.attr("type", "text"), o.addClass("ticker"), this.createLabeledCell($.t("Width (% of the Box)"), o).appendTo(T), $("<td>").append(o).appendTo(T), i = [s(40)], i.push(l(0)), i.push(p(100)), this.bindControl(new y(o, t.percentWidth, i, !1, this.model(), "Change Percent Width")), T = this.addLabeledRow(e, "Placement"), n = L(), $("<td>").append(n).appendTo(T), this.bindControl(new h(n, t.direction, null, !0, this.model(), "Change " + b + " Placement")), T = this.addRow(e), a = $("<input type='checkbox'>"), $("<td>").append(a).appendTo(T), this.createLabeledCell($.t("Show Values"), a).appendTo(T), this.bindControl(new c(a, t.showValues, !0, this.model(), "Change " + b + " Show Values")), T = this.addRow(e), r = this.createColorPicker(), this.createLabeledCell($.t("Text Color"), r).appendTo(T), $("<td>").append(r).appendTo(T), this.bindControl(new u(r, t.valuesColor, !0, this.model(), "Change " + b + " Text Color"));for (d in t.colors) {
        isNumber(parseInt(d, 10)) && (T = this.addRow(e), C[d] = t.titles[d].value(), g[d] = this.createColorPicker(), $("<td>").append(C[d]).appendTo(T), $("<td>").append(g[d]).appendTo(T), this.bindControl(new u(g[d], t.colors[d], !0, this.model(), "Change " + C[d] + " color")));
      }
    }, i._createRow_backgrounds = function (e, t) {
      var o = this.addRow(e),
          i = $("<input type='checkbox' class='visibility-switch'/>"),
          n = t.name.value(),
          a = this.createColorPicker();$("<td>").append(i).appendTo(o), this.createLabeledCell(n, i).appendTo(o), $("<td>").append(a).appendTo(o), this.bindControl(new c(i, t.visible, !0, this.model(), "Change " + n + " visibility")), this.bindControl(new u(a, t.color, !0, this.model(), "Change " + n + " color", t.transparency));
    }, i._createRow_polygons = function (e, t) {
      var o = this.addRow(e),
          i = t.name.value(),
          n = this.createColorPicker();$("<td>").append(i).appendTo(o), $("<td>").append(n).appendTo(o), this.bindControl(new u(n, t.color, !0, this.model(), "Change " + i + " color"));
    }, i._createRow_trendchannels = function (e, t) {
      var o = this.addRow(e),
          i = t.name.value(),
          n = this.createColorPicker();$("<td>").append(i).appendTo(o), $("<td>").append(n).appendTo(o), this.bindControl(new u(n, t.color, !0, this.model(), "Change " + i + " color", t.transparency));
    ...
    function i(e, t, o) {
      ...
      a.call(this, e, t, o), this.prepareLayout();
        ...
        h = o(1201);inherit(i, r), i.prototype.prepareLayout = function () {
      var e,
          t,
          o,
          i,
    ...
    function i(e, t, o) {
      ...
      r.call(this, e, t, o);
        ...
        u = o(1196).createLineWidthEditor;inherit(i, a), i.prototype.prepareLayout = function () {
      var e, t, o, i, n, a, r, l, C, y, g, T, w, _;this._res = $("<div>"), this._table = $('<table class="property-page" cellspacing="0" cellpadding="2" style="width:100%"></table>').appendTo(this._res), e = u(), t = b(), o = this.createColorPicker(), i = this.addLabeledRow(this._table, "Line"), $("<td>").append(o).appendTo(i), $("<td>").append(e).appendTo(i), $('<td colspan="3">').append(t.render().css("display", "block")).appendTo(i), n = $("<input type='checkbox' class='visibility-switch'>"), i = $("<tr>").appendTo(this._table), $('<td colspan="3">').append($("<label>").append(n).append($.t("Show Price"))).prependTo(i), a = $("<input type='checkbox'>"), i = $("<tr>").appendTo(this._table), $('<td colspan="3">').append($("<label>").append(a).append($.t("Show Text"))).prependTo(i), i = this.addLabeledRow(this._table, "Text:"), r = this.createColorPicker(), l = this.createFontSizeEditor(), C = this.createFontEditor(), y = $('<span class="_tv-button _tv-button-fontstyle"><span class="icon-fontstyle-bold"></span></span>'), g = $('<span class="_tv-button _tv-button-fontstyle"><span class="icon-fontstyle-italic"></span></span>'), $("<td>").append(r).appendTo(i), $("<td>").append(C).appendTo(i), $("<td>").append(l).appendTo(i), $("<td>").append(y).appendTo(i), $("<td>").append(g).appendTo(i), i = $("<tr>").appendTo(this._table), $("<td colspan='2'>").append($.t("Text Alignment:")).appendTo(i), T = $("<select><option value='left'>" + $.t("left") + "</option><option value='center'>" + $.t("center") + "</option><option value='right'>" + $.t("right") + "</option></select>"), w = $("<select><option value='bottom'>" + $.t("top") + "</option><option value='middle'>" + $.t("middle") + "</option><option value='top'>" + $.t("bottom") + "</option></select>").data("selectbox-css", { display: "block" }), $("<td>").append(T).appendTo(i), $("<td colspan='3'>").append(w).appendTo(i), _ = $("<textarea rows='7' cols='60'>").css("width", "100%"), i = $("<tr>").appendTo(this._table), $("<td colspan='7'>").append(_).appendTo(i), this.bindControl(new p(a, this._linetool.properties().showLabel, !0, this.model(), "Change Horz Line Text Visibility")), this.bindControl(new s(T, this._linetool.properties().horzLabelsAlign, null, !0, this.model(), "Change Horz Line Labels Alignment")), this.bindControl(new s(w, this._linetool.properties().vertLabelsAlign, null, !0, this.model(), "Change Horz Line Labels Alignment")), this.bindControl(new d(_, this._linetool.properties().text, null, !0, this.model(), "Change Text")), this.bindControl(new p(n, this._linetool.properties().showPrice, !0, this.model(), "Change Horz Line Price Visibility")), this.bindControl(new h(o, this._linetool.properties().linecolor, !0, this.model(), "Change Horz Line Color")), this.bindControl(new s(t, this._linetool.properties().linestyle, parseInt, !0, this.model(), "Change Horz Line Style")), this.bindControl(new c(e, this._linetool.properties().linewidth, !0, this.model(), "Change Horz Line Width")), this.bindControl(new s(l, this._linetool.properties().fontsize, parseInt, !0, this.model(), "Change Text Font Size")), this.bindControl(new s(C, this._linetool.properties().font, null, !0, this.model(), "Change Text Font")), this.bindControl(new h(r, this._linetool.properties().textcolor, !0, this.model(), "Change Text Color")), this.bindControl(new p(y, this._linetool.properties().bold, !0, this.model(), "Change Text Font Bold")), this.bindControl(new p(g, this._linetool.properties().italic, !0, this.model(), "Change Text Font Italic")), this.loadData();
    }, i.prototype.widget = function () {
      return this._res;
    }, inherit(n, r), n.prototype.prepareLayout = function () {
      var e, t, o, i;this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">'), (e = this._linetool.points()[0]) && (t = this._linetool.properties().points[0], o = this.createPriceEditor(t.price), i = $("<tr>").appendTo(this._table), $("<td>" + $.t("Price") + "</td>").appendTo(i), $("<td>").append(o).appendTo(i), this.loadData());
    ...
    function i(e, t, o) {
      ...
      var e = this._linetool,
          ...
          i = e.riskFormatter(o);this._riskEdit.data("TVTicker", { step: e.getRiskStep(o), formatter: i.format.bind(i) });
      ...
      return this._table;
    }, t.LineToolRiskRewardInputsPropertyPage = i, t.LineToolRiskRewardStylesPropertyPage = n;
    ...
    function i(e, t, o) {
      ...
      r.call(this, e, t, o);
        ...
        h = l.ColorBinding,
        c = o(1197).createLineStyleEditor,
        b = o(1196).createLineWidthEditor;inherit(i, a), i.prototype.prepareLayout = function () {
