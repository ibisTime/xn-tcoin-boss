...
define('js/app/interface/TradeCtr', ['js/app/controller/base', 'js/app/util/ajax'], function (base, Ajax) {
    return {
        ...
        //阅读消息
        readNews: function readNews(config) {
            return Ajax.post("805310", config);
        },

        // 列表查付款方式
        getPayTypeList: function getPayTypeList(data) {
            return Ajax.post("625350", data, true);
        },

        // 列表查交易货币
        getPayCoinList: function getPayCoinList(name) {
            return Ajax.post("625370", name, true);
        },

        // 获取币种行情
        getMarket: function getMarket(ex_type) {
        ...
        // 列表查标签
        getTagsList: function getTagsList(config) {
            return Ajax.post('625330', config, true);
        },

        // 列表查国家
        getCountryList: function getCountryList(config) {
         ...
         * @param adsCode
         */
        submitAdvertise: function submitAdvertise(config) {
